            ...
            <div>
                  ...
                  <div style="overflow: auto">
                    ...
                    <table class="table table-binvoiceed">
                      ...
                      <tbody>
                        ...
                        <tr v-if="fill_fields_error"><td colspan="5"><label class="label label-danger">Please fill all empty fields before adding another row</label></td></tr>
                        <tr>
              ...
              <el-row :gutter="2" class="padded">
                <el-col :xs="24" :sm="6" :md="6">
                  <el-button type="success" @click="updateInvoice"><i class="el-icon-edit" />
                    Update Invoice
                  </el-button>
                </el-col>
              </el-row>
...
export default {
  ...
  methods: {
    ...
    updateInvoice() {
      const app = this;
      var form = app.form;
      const checkEmptyFields = (form.warehouse_id === '' || form.customer_id === '' || form.invoice_date === '' || form.currency_id === '');
      if (!checkEmptyFields) {
        const load = editInvoice.loaderShow();
        form.invoice_items = app.invoice_items;
        editInvoice.update(form.id, form)
          .then(response => {
            app.$message({ message: 'Invoice Updated Successfully!!!', type: 'success' });
