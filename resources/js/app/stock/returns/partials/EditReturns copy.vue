    ...
    <div class="box-body">
        ...
        <el-form ref="form" :model="form" label-width="120px">
          <el-row :gutter="5" class="padded">
            <el-col :xs="24" :sm="12" :md="12">
              ...
              <el-select v-model="form.item_id" disabled placeholder="Select Product" filterable class="span">
              ...
              <el-alert type="error">Maximum quantity returnable for this batch is {{ form.max_returnable_quantity }}</el-alert>
      ...
      <el-row :gutter="2" class="padded">
        <el-col :xs="24" :sm="6" :md="6">
          <el-button :disabled="form.quantity > form.max_returnable_quantity" type="success" @click="editReturnedProduct"><i class="el-icon-edit" />
            Update
          </el-button>
        </el-col>
      </el-row>
